  ...
  <div class="login-wrap">
    <div class="login-card">
      <div class="login-copy">
        ...
        <div class="stack">
          <h1 style="margin: 0; font-size: 28px">设计师工作台</h1>
          <p class="muted" style="margin: 0; line-height: 1.7">
            用于创建项目、推进阶段、归档文件、维护案例。
          </p>
        </div>
        <div class="surface pad">
          ...
          <div class="stack">
            <div class="badge primary">设计师：designer@example.com / 123456</div>
            <div class="badge">客户：customer@example.com / 123456</div>
          </div>
        </div>
      </div>
