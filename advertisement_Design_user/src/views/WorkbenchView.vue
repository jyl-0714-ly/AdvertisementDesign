    ...
    <aside v-if="activeProject" class="project-inspector" :class="{ open: inspectorOpen }">
      ...
      <section class="project-facts">
        <div class="project-cover" aria-label="项目视觉封面">
          ...
          <small>NO.{{ String(activeProject.id).padStart(3, '0') }}</small>
        </div>
      ...
      <section class="project-team">
        <header>协作信息</header>
        <div><span>客户联系人</span><strong>{{ activeProject.customerName || auth.user?.nickname || '—' }}</strong></div>
...
/* =====================================================
   USER 端 工作台 — 全量重写
   色彩系统：
     墨黑 #0f172a | 琥珀 #c0742a | 绿色达成 #1a8a5c
   ===================================================== */
...
.stage-flow > button.pending small { color: #c0742a; }
...
.current-stage-card {
  ...
  border-left: 3px solid #c0742a !important;
  border-radius: 0 8px 8px 0 !important;
  display: grid !important;
  align-content: center;
  background: #fef8f2 !important;
}
.current-stage-card span { color: #a0622a; font-size: 11px; }
...
.inspector-project-link:hover { border-color: #c0742a; color: #c0742a; }
...
.inspector-stage-action.pending header small { color: #c0742a; }
...
.compact-timeline > button.pending > i { background: #c0742a; box-shadow: 0 0 0 1px #c0742a; }
...
.compact-timeline > button.pending small { color: #c0742a; }
