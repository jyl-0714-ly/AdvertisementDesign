...
description: 广告设计公司客户对接平台后端专属开发规范。Use when developing, generating, refactoring, migrating, or reviewing code under advertisement_Design_back. Enforces the project's Modular Monolith business modules (auth, identity, consultation, project, communication, portfolio, common), module dependency boundaries, incremental DemoDataStore-to-MySQL migration, Spring Boot 3.2, Java 17, MyBatis-Plus 3.5, DTO/VO boundaries, Swagger/OpenAPI, Result wrapper, BCrypt, MapStruct, and Java Config.
---
